...
class VerifyPreviousPinScreen : Screen {
  @Composable
  override fun Content() {
    val vm = koinViewModel<VerifyPreviousPinViewModel>()

    SubScreenRoot(title = "") {
      Spacer(Modifier.weight(1f))
      Column(Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
        AppText(
          text = "Enter your previous PIN",
        ...
        AppText("Please enter your previous pin to decrypt the data.", Modifier.padding(bottom = 32.dp))
